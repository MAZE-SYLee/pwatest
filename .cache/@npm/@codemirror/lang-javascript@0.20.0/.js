import { parser } from '/@npm/@lezer/javascript';
import { LRLanguage, indentNodeProp, continuedIndent, flatIndent, delimitedIndent, foldNodeProp, foldInside, LanguageSupport, syntaxTree } from '/@npm/@codemirror/language';
import { EditorSelection } from '/@npm/@codemirror/state';
import { EditorView } from '/@npm/@codemirror/view';
import { snippetCompletion, ifNotIn, completeFromList } from '/@npm/@codemirror/autocomplete';
